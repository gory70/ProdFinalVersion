    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facture', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.facture')),
            ],
        ),
        migrations.AddField(
            model_name='facture',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.production')),
            ],
        ),
        migrations.CreateModel(
